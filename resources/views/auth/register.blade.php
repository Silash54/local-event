    ...
    <main>
        <div class="register-section bg-[#e2e2e2] flex justify-center min-h-screen items-center ">
            <div class="main-container  bg-[#fff] p-30 border-gray-200 shadow-md">
                ...
                <form action="{{ route('registerPost') }}" method="post" class="flex-col justify-between items-center gap-4">
                    @csrf
                    <!-- Username -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 h-10 px-4" placeholder="name@example.com" required />
                    </div>
                    <div>
                    ...
                    <div>
                        <span>I Already have an Account?</span><a href="{{ route('login') }}" style="color: aquamarine">
                            Login</a>
                    </div>
                </form>
            </div>
        ...
        <div class="mx-auto w-full max-w-screen-xl">
            <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium flex gap-4">
                        <li class="mb-4">
                            <a href="#" class="text-gray-400 hover:text-red-900 dark:hover:text-white">
                                <svg class="w-4 h-4 text-red-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a
                        href="https://flowbite.com/">Silas</a>. All Rights Reserved.
                </span>
            </div>
        </div>
    </footer>
